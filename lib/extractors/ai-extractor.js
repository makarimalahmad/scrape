...
/**
 * Ekstraktor Fallback Berbasis AI (OpenAI-Compatible Universal Client)
 * Mendukung berbagai provider: DeepSeek, OpenAI, Groq, OpenRouter, dll.
 * Hanya aktif jika ekstraksi DOM biasa gagal dan AI_API_KEY, AI_BASE_URL, AI_MODEL tersedia.
 */
