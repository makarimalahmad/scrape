...
async function searchGoogle(
  ...
  // Smart fallback: jika hasil ranking kompetitor terlalu sedikit (< 3) dan belum menggunakan filter "0",
  // coba query ulang menggunakan filter "0" agar Google membuka toko-toko yang disaring sebagai hasil serupa
  if (ranking.length < 3 && !parameters.has("filter")) {
    console.log(
      `[Google Search] Toko kompetitor organik sedikit (${ranking.length}). Mencoba ulang dengan filter: "0"...`,
    );
