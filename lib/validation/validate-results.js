...
const PRODUCT_PATTERN =
  /(?:diamond|\bdm\b|berlian|pass|booyah|evo\s*vault|pack|bundle|membership|member|card|voucher|robux|roblox|\buc\b|point|token|crystal|gold|coin|credit|starlight|twilight|weekly|monthly|top\s*up)/i;
